...
handleEditorChange = (contentVal, editor) => {
    ...
    console.log('Content was updated:', contentVal);
  }
...
componentDidMount(){
    ...
    var editResult={}
    if(!localStorage.editblog){
        this.props.history.push('/admin/listblog')

    }else{
        editResult=JSON.parse(localStorage.getItem('editblog'))
    }
    this.setState({
        _id:editResult._id,
        photoUrl   :   editResult.photoUrl,
        content :   editResult.content,
        shortContent :   editResult.shortContent,
        title :   editResult.title,
        blogType :   editResult.blogType,
        visiblity:   editResult.visiblity,  //visible,hidden
        storeID:editResult.storeID, 
        sliderImage:editResult.sliderImage ? JSON.parse(editResult.sliderImage) :[]
...
componentWillReceiveProps(nextProps){
    ...
    if(nextProps.blog.editblog !== this.props.blog.editblog){
        Toast.fire({
            type: 'success',
        ...
        <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
          ...
          <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
            ...
            <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
              {/* begin:: Subheader */}
              <SubHeader first="Home" second="Edit Blog" third="Edit Blog"/>
              {/* end:: Subheader */}
              {/* begin:: Content */}
