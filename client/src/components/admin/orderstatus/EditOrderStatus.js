...
import {editOrderStatus} from '../../../actions/orderstatusAction';
...
componentDidMount(){
    ...
    var editResult={}
    if(!localStorage.editorderstatus){
        this.props.history.push('/admin/listorderstatus')

    }else{
        editResult=JSON.parse(localStorage.getItem('editorderstatus'))
    }
    this.setState({
        _id:editResult._id,
        StatusName   :   editResult.StatusName,
        visibility :   editResult.visibility,
...
componentWillReceiveProps(nextProps){
    ...
    if(nextProps.orderstatus.editorderstatus !== this.props.orderstatus.editorderstatus){
        Toast.fire({
            type: 'success',
            title: 'OrderStatus Edited Successfully',
          }).then(navigate=>{
            this.props.history.push('/admin/listorderstatus');
          })
...
onSubmit(e){
    ...
    this.props.editOrderStatus(orderstatusData);
}
        ...
        <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
          ...
          <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
            ...
            <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
              {/* begin:: Subheader */}
              <SubHeader first="Home" second="Edit OrderStatus" third="Edit OrderStatus"/>
              {/* end:: Subheader */}
              {/* begin:: Content */}
...
export default connect(mapStateToProps,{editOrderStatus})(EditOrderStatus);