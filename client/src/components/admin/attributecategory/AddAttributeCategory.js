...
import {addAttributeCategory} from '../../../actions/attributecategoryAction';
import axios from 'axios';
import swal from 'sweetalert2';
import ListAttributeCategory from './ListAttributeCategory';
...
class AddAttributeCategory extends Component {
  constructor(){
    super();
    this.state={
       errors:{},
...
componentWillReceiveProps(nextProps){
    ...
    if(nextProps.attributecategory.addattributecategory !== this.props.attributecategory.addattributecategory){
        Toast.fire({
            type: 'success',
            title: ' Attribute Category Added Successfully',
          })
          this.onReset();
    }
...
onSubmit(e){
    ...
    this.props.addAttributeCategory(Data);
}
        ...
        <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
          ...
          <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
            ...
            <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
             ...
             <ListAttributeCategory history={this.props.history}/>
              {/* end:: Content */}
            </div>
            {/* begin:: Footer */}
            <Footer/>
...
AddAttributeCategory.propTypes ={
    auth: PropTypes.object.isRequired,
    addAttributeCategory: PropTypes.func.isRequired,
...
export default connect(mapStateToProps,{addAttributeCategory})(AddAttributeCategory);