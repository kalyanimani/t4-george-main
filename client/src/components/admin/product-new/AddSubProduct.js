...
class AddProductSub extends Component {
    ...
    Axios.get("/api/productsub/quickbook/getredirect")
      .then((result) => {
        ...
        localStorage.setItem(
          "quickbook_back",
          `/admin/addsub?productID=${this.state.productID}`
        );
      })
      .catch((err) => {
        Toast.fire({
  ...
  render() {
    ...
    if (searchTerm == null || searchTerm === "") {
      ...
      var filterData = ProductSubData.filter(
        createFilter(this.state.searchTerm, KEYS_TO_FILTERS)
      );
      tableResult = filterData.map((result) => {
        var findSub = listproductsub.find(
          (x) => x.productSubName === result.productSubName
        );
        return (
          <tr>
            ...
            <td>
              {checkPermission(this.props.auth, "PRODUCTS", "CREATE") &&
                !findSub && (
                  <button
                    className='btn btn-link'
                    onClick={() => this.onSubmit(result)}
                  >
                    <span className='kt-badge kt-badge--brand kt-badge--inline kt-badge--success'>
                      ADD
                    </span>
                  </button>
                )}
                    ...
                    {this.state.quickBookLogin ? (
                          ...
                          <div className='form-group row'>
                            ...
                            <div className='col-lg-3'>
                              <input
                                ...
                                value={this.state.productSubName}
                          ...
                          <div className='form-group row'>
                            ...
                            <div className='col-lg-3'>
                              <input
                                ...
                                name='incomeAccount'
                                onChange={this.onChange}
                                value={this.state.incomeAccount}
                                className='form-control'
                                placeholder=''
                              />
                              <span className='form-text text-danger'>
                          ...
                          <div className='form-group row'>
                            ...
                            <div className='col-lg-3'>
                              <input
                                ...
                                name='expenseAccount'
                                onChange={this.onChange}
                                value={this.state.expenseAccount}
                                className='form-control'
                                placeholder=''
                              />
                              <span className='form-text text-danger'>
                          ...
                          <div className='form-group row'>
                            ...
                            <div className='col-lg-3'>
                              <input
                                ...
                                name='inventoryAsset'
                                onChange={this.onChange}
                                value={this.state.inventoryAsset}
                                className='form-control'
                                placeholder=''
                              />
                              <span className='form-text text-danger'>
                            ...
                            <div className='col-lg-3'>
                              <input
                                ...
                                name='quantityAsDate'
                                onChange={this.onChange}
                                value={this.state.quantityAsDate}
                                className='form-control'
                                placeholder=''
                              />
                              <span className='form-text text-danger'>
                      ...
                      <div className='text-center p-2'>
                        <button
                          type='button'
                          className='btn btn-success'
                          onClick={() => this.onGetQuickBook()}
                        >
                          Connect With Quickbook
                        </button>
                      </div>
                    )}
...
export default connect(mapStateToProps, { addProductSub, listProductSub })(
  AddProductSub
);
