  ...
  render() {
    ...
    if (listattributemapping == null || attributemappingloading) {
      ...
      if (Object.keys(listattributemapping).length > 0) {
        var filterData = listattributemapping.filter(
        ...
        tableResult = filterData.map((result) => {
          return (
            <tr>
              <td>
                {result.parentattributecategory
                  ? result.parentattributecategory.attributeName
                  : "N/A"}
              </td>
              <td>
                {result.attributecategory
                  ? result.attributecategory.attributeName
                  : "N/A"}
              </td>
