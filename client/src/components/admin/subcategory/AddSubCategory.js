...
componentWillReceiveProps(nextProps){
    ...
    if(nextProps.subCategory.addsubCategory !== this.props.subCategory.addsubCategory){
        Toast.fire({
            type: 'success',
        ...
        <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
          ...
          <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
            ...
            <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
              {/* begin:: Subheader */}
              <SubHeader first="Home" second="Add Sub-Group" third=""/>
              {/* end:: Subheader */}
              {/* begin:: Content */}
...
export default connect(mapStateToProps,{addSubCategory,listCategory})(AddSubCategory);