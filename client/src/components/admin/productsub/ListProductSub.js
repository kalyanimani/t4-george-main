...
import {listProductSub,deleteProductSub} from '../../../actions/productsubAction'
...
componentWillReceiveProps(nextProps){
  ...
  if(nextProps.productsub.deleteproductsub !== this.props.productsub.deleteproductsub){
      Toast.fire({
          type: 'success',
...
render() {
  ...
  if(listproductsub==null ||productsubloading){
      ...
      if(Object.keys(listproductsub).length >0){
        var filterData= listproductsub.filter(createFilter(this.state.searchTerm, KEYS_TO_FILTERS))
...
export default connect(mapStateToProps,{listProductSub,deleteProductSub})(ListProductSub);