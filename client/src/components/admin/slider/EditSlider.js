...
import {editSlider} from '../../../actions/sliderAction';
...
componentDidMount(){
    ...
    var editResult={}
    if(!localStorage.editslider){
        this.props.history.push('/admin/listslider')

    }else{
        editResult=JSON.parse(localStorage.getItem('editslider'))
    }
    this.setState({
        _id:editResult._id,
        photoUrl   :   editResult.photoUrl,
        sliderName :   editResult.sliderName,
        sliderNameAr :   editResult.sliderNameAr,
        ...
        sliderTitle:editResult.sliderTitle,
        sliderDesc:editResult.sliderDesc
...
componentWillReceiveProps(nextProps){
    ...
    if(nextProps.slider.editslider !== this.props.slider.editslider){
        Toast.fire({
            type: 'success',
...
//onchange state value for slider
onChange(e){
...
onSubmit(e){
    ...
    const sliderData ={
        ...
        sliderNameAr:this.state.sliderNameAr,
    ...
    this.props.editSlider(sliderData);
}
        ...
        <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
          ...
          <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
            ...
            <div className="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
              {/* begin:: Subheader */}
              <SubHeader first="Home" second="Edit Slider" third="Edit Slider"/>
              {/* end:: Subheader */}
              {/* begin:: Content */}
...
EditSlider.propTypes ={
  ...
  editSlider: PropTypes.func.isRequired,
...
export default connect(mapStateToProps,{editSlider})(EditSlider);